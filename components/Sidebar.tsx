      ...
      `}>
        ...
        <div className="p-4">
          <button
            ...
            className="w-full bg-brand-cyan hover:bg-brand-cyan/90 text-white px-4 py-2.5 rounded-xl text-sm font-medium flex items-center justify-center gap-2 transition-all duration-200 shadow-lg shadow-brand-cyan/20 hover:shadow-xl hover:shadow-brand-cyan/30 hover:scale-[1.02]"
          >
            <Plus size={18} />
            New Chat
          </button>
                ...
                {chats.length === 0 ? (
                  ...
                  chats.map((chat) => (
                    <button
                      ...
                      className={`w-full text-left px-3 py-2 rounded-lg text-sm transition-all duration-200 group ${currentChatId === chat.id
                        ? "bg-brand-cyan/10 dark:bg-brand-cyan/20 text-brand-cyan shadow-sm border border-brand-cyan/20"
        ...
        <div className="p-4 border-t border-zinc-200/50 dark:border-zinc-700/50 bg-white/40 dark:bg-zinc-800/40 backdrop-blur-sm">
          <div className="flex items-center gap-3">
            <div className="w-9 h-9 rounded-full bg-brand-cyan flex items-center justify-center text-white font-semibold text-sm shadow-md">
